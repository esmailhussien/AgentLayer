...
This skill is derived from the `networkx` skill in `K-Dense-AI/scientific-agent-skills`.
...
- **Local path:** `skills/networkx/`

## Imported Files

- `SKILL.md`
- `references/` (`algorithms.md`, `generators.md`, `graph-basics.md`, `io.md`, `visualization.md`)
