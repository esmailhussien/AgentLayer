...
This skill is derived from the `unit-testing` skill in `arjunprabhulal/agent-skills`.
...
- **Local path:** `skills/unit-testing/`
...
- Upstream evals imported under `tests/upstream/arjunprabhulal-agent-skills/unit-testing/`.
