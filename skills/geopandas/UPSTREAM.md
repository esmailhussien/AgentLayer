...
This skill is derived from the `geopandas` skill in `K-Dense-AI/scientific-agent-skills`.
...
- Upstream evals / tests: Vendored into `tests/upstream/kdense-scientific-agent-skills/geopandas/`.
